...
ระบบจำแนกตัวเลขไทย (๒๑ ถึง ๒๕) จากลายมือเขียนด้วยปัญญาประดิษฐ์ (Deep Learning) พัฒนาในรูปแบบ Web Application 

โปรเจกต์นี้เป็นส่วนหนึ่งของการศึกษา เพื่อสร้างโมเดล Machine Learning แบบ End-to-End ตั้งแต่การสร้างชุดข้อมูล (Data Generation), การฝึกสอนโมเดล (Model Training), การเก็บข้อมูลเพิ่มจากผู้ใช้งาน (Data Collection), และการนำไปใช้งานจริง (Deployment)
